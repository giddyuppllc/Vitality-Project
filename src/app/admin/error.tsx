...
// Scoped error boundary for the admin segment. Without this, any throw in an
// admin page bubbled to the global app error and replaced the ENTIRE screen
// (sidebar included), making one bad query feel like "the whole dashboard is
// broken." Caught here, the admin shell/layout stays mounted and the admin can
  ...
  return (
    <div className="flex items-center justify-center px-4 py-16">
      <div className="glass rounded-2xl p-10 max-w-lg w-full text-center">
        ...
        <h1 className="text-2xl font-bold mb-3">This admin page hit an error</h1>
        <p className="text-white/60 mb-2 leading-relaxed">
          Something in this view failed to load — the rest of the dashboard is fine.
          Try again, or head back to the dashboard. A common cause is a stale or
          invalid filter in the URL.
        </p>
        {error?.digest && (
